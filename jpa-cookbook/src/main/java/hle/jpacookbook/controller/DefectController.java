...
public class DefectController {
    ...
    @GetMapping("/views/judges")
    public List<DefectView> getViewsByAttr(@RequestParam String defectType, @RequestParam String defectVal) {
        var judge = new JudgeQuery(defectType, defectVal);
        return defectAggregateRepository.getRecordsByJudge(judge);
    }
}
